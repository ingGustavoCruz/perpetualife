...
<head>
    ...
    <title>Política de Privacidad | Perpetualife</title>
...
<body class="min-h-screen bg-slate-50 dark:bg-gray-900 text-gray-900 dark:text-white font-sans transition-colors duration-500">
    <div class="max-w-4xl mx-auto px-6 py-12">
        ...
        <div class="bg-white dark:bg-gray-800 p-10 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700">
            <h1 class="text-3xl font-black text-perpetua-blue dark:text-perpetua-aqua mb-6 uppercase">Política de Privacidad</h1>
            ...
            <div class="prose dark:prose-invert max-w-none text-gray-500 dark:text-gray-400">
                ...
                <p class="italic">
                    [Este documento detalla cómo recolectamos, usamos y protegemos los datos personales de nuestros clientes 
                    (Cookies, Emails, Direcciones) en cumplimiento con las leyes de protección de datos.]
                </p>
